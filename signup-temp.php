...
<body style="background-image:url('a.jpg'); background-repeat: no-repeat; background-attachment:fixed;">
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div id="navbar" class="navbar-collapse collapse">
         <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="loginpage.php"><label>Sign-in</label></a></li>
            <li><a href="sign-in.php"></a></li>
          </ul> 
	...
	<div style=" opacity:.4; background-color:whitesmoke; position:relative; heigth:100px; width:1120px; margin-left:200px; min-height:620px;position:absolute;" >
