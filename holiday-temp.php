	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
			...
			<form class="navbar-form navbar-right">
				...
				<li style="color:gray; margin-top:15px;"><b>WELCOME </b></li>
				<li><a href="uprofile.php"><b><?php echo $_SESSION['user'];?></b></a></li>
				<li style="font-size:30px;"> | <div class="btn-group">
					  <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						Action <span class="caret"></span>
					  </button>
					  <ul class="dropdown-menu">
						<li><a href="nholidays.php">Holidays</a></li>
						<li><a href="uabout.php">About</a></li>
						<li><a href="uprofile.php">Edit Profile</a></li>
